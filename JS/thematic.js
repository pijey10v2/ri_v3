...
async function updateThematic() {
    ...
    //thematicProps.roadAsset = tilesetlist
    var legendsTable = legendsTable = document.getElementById("pipeLegends")
    switch (pipeAttr) {
        case "Material":
            if (!thematicProps.pipeEntities) {
                return
            }
            thematicProps.pipeEntities.forEach(function (entity) {
                if (entity._polyline !== undefined) {
                    entity._polyline.width = 3;
                    switch (entity._kml.extendedData.MATERIAL.value) {
                        case "AC":
                            entity._polyline.material = Cesium.Color.YELLOW
                            break;
                        case "DI":
                            entity._polyline.material = Cesium.Color.RED
                            break;
                        case "STL":
                            entity._polyline.material = Cesium.Color.BLUE
                            break;
                        case "HDPE":
                            entity._polyline.material = Cesium.Color.GREEN
                            break;
                        default:
                            entity._polyline.material = Cesium.Color.WHITE
                            break;
                    }
                }
            })
            legendsTable.innerHTML = "<tr><td style='background-color:rgb(255, 255, 0);font-family: Arial, Helvetica, sans-serif;'>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</td><td style>AC</td></tr>"
            legendsTable.innerHTML += "<tr><td style='background-color:rgb(255, 0, 0);font-family: Arial, Helvetica, sans-serif;'>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</td><td>DI</td></tr>"
            legendsTable.innerHTML += "<tr><td style='background-color:rgb(0, 100, 255);font-family: Arial, Helvetica, sans-serif;'>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</td><td>STL</td></tr>"
            legendsTable.innerHTML += "<tr><td style='background-color:rgb(51, 255, 51);font-family: Arial, Helvetica, sans-serif;'>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</td><td>HDPE</td></tr>"
            legendsTable.innerHTML += "<tr><td style='background-color:rgb(255, 255, 255);font-family: Arial, Helvetica, sans-serif;'>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</td><td>Others</td></tr "
            break;
        case "Diameter":
            if (!thematicProps.pipeEntities) {
                return
            ...
            thematicProps.pipeEntities.forEach(function (entity) {
                if (entity._polyline !== undefined) {
                    entity._polyline.width = 3;
                    switch (entity._kml.extendedData.D.value) {
                        case "152.4":
                            entity._polyline.material = new Cesium.Color(0.1, 0.95, 0.03, 1)
                            break;
                        case "203.2":
                            entity._polyline.material = new Cesium.Color(0.37, 0.94, 0.02, 1)
                            break;
                        case "254":
                            entity._polyline.material = new Cesium.Color(0.65, 0.93, 0.02, 1)
                            break;
                        case "304.8":
                            entity._polyline.material = new Cesium.Color(0.93, 0.93, 0.01, 1)
                            break;
                        case "355.6":
                            entity._polyline.material = new Cesium.Color(0.92, 0.64, 0.01, 1)
                            break;
                        case "406.4":
                            entity._polyline.material = new Cesium.Color(0.91, 0.35, 0, 1)
                            break;
                        case "457.2":
                            entity._polyline.material = new Cesium.Color(1, 0.07, 0, 1)
                            break;
                        case "508":
                            entity._polyline.material = new Cesium.Color(0.9, 0, 0.2, 1)
                            break;
                        default:
                            break;
                    }
                    legendsTable.innerHTML = "<tr><td style='background-color:rgb(10%, 95%, 3%);font-family: Arial, Helvetica, sans-serif;'>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</td><td>152.4mm</td></tr>"
                    legendsTable.innerHTML += "<tr><td style='background-color:rgb(37%, 94%, 2%);font-family: Arial, Helvetica, sans-serif;'>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</td><td>203.2mm</td></tr>"
                    legendsTable.innerHTML += "<tr><td style='background-color:rgb(65%, 93%, 2%);font-family: Arial, Helvetica, sans-serif;'>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</td><td>254mm</td></tr>"
                    legendsTable.innerHTML += "<tr><td style='background-color:rgb(93%, 93%, 1%);font-family: Arial, Helvetica, sans-serif;'>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</td><td>304.8mm</td></tr>"
                    legendsTable.innerHTML += "<tr><td style='background-color:rgb(92%, 64%, 1%);font-family: Arial, Helvetica, sans-serif;'>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</td><td>355.6mm</td></tr "
                    legendsTable.innerHTML += "<tr><td style='background-color:rgb(91%, 35%, 0%);font-family: Arial, Helvetica, sans-serif;'>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</td><td>406.4mm</td></tr>"
                    legendsTable.innerHTML += "<tr><td style='background-color:rgb(100%, 7%, 0%);font-family: Arial, Helvetica, sans-serif;'>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</td><td>457.2mm</td></tr>"
                    legendsTable.innerHTML += "<tr><td style='background-color:rgb(90%, 0%, 20%);font-family: Arial, Helvetica, sans-serif;'>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</td><td>508mm</td></tr>"
                }
            })
            break;
        case "Type":
            if (!thematicProps.cpEntities) {
                return
            }
            thematicProps.cpEntities.forEach(function (entity) {
                if (entity._kml.extendedData !== undefined && entity._polygon) {
                    console.log(entity)
                    switch (entity._kml.extendedData.Type.value) {
                        case "Building/Structure":
                            entity._polygon.material = new Cesium.Color(0.1, 0.95, 0.03, 1)
                            //  entity._polygon.outlineColor = new Cesium.Color(0.1, 0.95, 0.03, 1)
                            break;
                        case "TBM":
                            entity._polygon.material = new Cesium.Color(0, 0, 1, 1)
                            //   entity._polygon.outlineColor  = new Cesium.Color(0, 0, 1, 1)
                            break;
                        case "Rail Station":
                            entity._polygon.material = new Cesium.Color(0.9, 0, 0.2, 1)
                            //   entity._polygon.outlineColor  = new Cesium.Color(0.9, 0, 0.2, 1)
                            break;
                        default:
                            break;
                    }

                    legendsTable.innerHTML = "<tr><td style='background-color:rgb(10%, 95%, 3%);font-family: Arial, Helvetica, sans-serif;'>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</td><td>Building/Structure</td></tr>"
                    legendsTable.innerHTML += "<tr><td style='background-color:rgb(0%, 0%, 100%);font-family: Arial, Helvetica, sans-serif;'>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</td><td>TBM</td></tr>"
                    legendsTable.innerHTML += "<tr><td style='background-color:rgb(90%, 0%, 20%);font-family: Arial, Helvetica, sans-serif;'>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</td><td>Rail Station</td></tr>"
                }
            })
            break;
        case "PLC_Building":
            if (!thematicProps.plcEntities) {
                return
            }
            thematicProps.plcEntities.forEach(function (entity) {
                if (entity._kml.extendedData !== undefined && entity._polygon) {
            ...
            legendsTable.innerHTML += "<tr><td style='background-color:rgb(10%, 90%, 10%);font-family: Arial, Helvetica, sans-serif;'>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</td><td>Surau/Structure</td></tr>"
            ...
            $.ajax({
                ...
                success: function (obj, textstatus) {
                    ...
                    thematicProps.landEntities.forEach((entity) => {
                        ...
                        if (!entity._kml.extendedData.LOT && entity._kml.extendedData.LOT.value !== undefined && !entity._polygon){
                            return;
                        }
                        if(entity && entity._polygon && entity._polygon.material && entity._polygon.material._color && entity._polygon.material._color._value && entity._polygon.material._color._value.red && entity._polygon.material._color._value.green && entity._polygon.material._color._value.blue && entity._polygon.material._color._value.alpha){
                            originalColorLot = [
                                entity._polygon.material._color._value.red, 
                                entity._polygon.material._color._value.green, 
                                entity._polygon.material._color._value.blue, 
                                entity._polygon.material._color._value.alpha
                            ];
                        }
        ...
        case "LT":
            ...
            thematicProps.landEntities.forEach(function (entity) {
                ...
                if (!entity._kml.extendedData.STRUCTURE_ && entity._kml.extendedData.STRUCTURE_.value !== undefined && !entity._polygon){
                    return;
                }
...
async function removeTheme() {
    ...
    if (thematicProps.pipeEntities) {
        while (i < tilesetlist.length) {
            if ("Data/KML/PIPE.kml" == tilesetlist[i].url) {
    ...
    else if (thematicProps.cpEntities) {
        while (i < tilesetlist.length) {
            if ("Data/KML/Building.kml" == tilesetlist[i].url) {
                viewer.dataSources.remove(tilesetlist[i].tileset);
                mykml = await LoadKMLData(tilesetlist[i].url)
                tilesetlist[i].tileset = mykml
                break;
    ...
    else if (thematicProps.plcEntities) {
        while (i < tilesetlist.length) {
            if (tilesetlist[i].url.includes("PLC_Building")) {
                viewer.dataSources.remove(tilesetlist[i].tileset);
                mykml = await LoadKMLData(tilesetlist[i].url)
                tilesetlist[i].tileset = mykml
                break;
    ...
    else if (thematicProps.landEntities) {
        if(!originalColorLot){
            while (i < tilesetlist.length) {
        ...
        originalColorLot = [];
    }else if(thematicProps.roadAsset){
        thematicProps.roadAsset.forEach((entity) => {
            if(entity._polyline != undefined)
            entity._polyline.material = new Cesium.Color(originalColorLot[0],originalColorLot[1],originalColorLot[2],originalColorLot[3]);
    ...
    console.log("clear and load done")
}