    ...
    $.assignBrowse = function(domNodes, isDirectory){
      ...
      $h.each(domNodes, function(domNode) {
        ...
        if(domNode.tagName==='INPUT' && domNode.type==='file'){
          ...
          input.focus();
			    input.setAttribute('id','R_input');
          input.click();
          input.style.display='none';
          switch(uploadType){
            case "KML":
              input.setAttribute('accept', '.kml,.kmz');
              break;
            case "XML":
              input.setAttribute('accept', '.xml');
              break;
            case "VIDEO":
              input.setAttribute('accept', '.mp4,.ogg');
              break;
            case "AIC":
              if(SYSTEM == 'OBYU'){
                input.setAttribute('accept', '.png,.bmp,.jpeg,.jpg');
              }else{
