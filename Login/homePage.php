                ...
                <div class="toolContainer">
                    <div class="leftToggleContainer">
                        ...
                        <div class="tool iot" style="display: none;">
                            <div class="flexContainer">
                                <div class="buttonContainer">
                                    <button class="toolButton mid" rel="controlPanel" title="IoT Control Panel" data-width="70" onclick= ""><i class="fa-solid fa-rss"></i><div class="label">IoT<br>Control Panel</div></button>
                                    <button class="toolButton mid register" rel="addIoT" title="Register Iot Sensor" data-page="iotItem" ><i class="fa-solid fa-square-rss"></i><div class="label">Register<br>IoT</div></button>
                                    <button class="toolButton mid manage" rel="manageIoT" title="Manage IoT" onclick = "OnClickManageIoT()"><i class="fa-solid fa-satellite-dish"></i><div class="label">Manage<br>IoT</div></button>
                                </div>
                            </div>
