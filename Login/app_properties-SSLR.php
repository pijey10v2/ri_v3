...
if ($PRODUCTION_FLAG) {
	...
	$RIHOST = "https://ri.maltimur.com.my/RIConstruct/";

	// link
	$JOGETDOMAIN = "https://doc.maltimur.com.my/";  
	$JOGETIP = "http://192.168.23.239:8080/";
	// password
	$JOGETADMINUSER = "admin";
    $JOGETADMINPWD = "@dmin123+";

    // link geoserver
    $GEOSERVERDOMAIN = "https://geo.maltimur.com.my";
    $GEOSERVERIP = "http://192.168.23.250:8080";
    //password geoserver
