            ...
            <div class="uploadContainer">
                <div class="buttoncontainer">
                    ...
                    <div>
                        ...
                        <input type="date" id="uploaded-date" required>
                    </div>
                    <input type="file" name="uploadExcelInput" id="uploadExcelInput" accept=".xls,.xlsx" style="">
...
<!-- <div class="buttoncontainer">
                    ...
                    <input type="date" id="uploaded-date">
