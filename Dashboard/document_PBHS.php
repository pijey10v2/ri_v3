...
$dashObj = new RiDashboard('document_PBHS');
    ...
    $html .= ' <div class = "dashboardBody">
            <div class="sidebar">
                <div class="filterContainer">
                    <div class="filter" style="display:'.(($dashObj->isWPC) ? 'none' : 'block').'; background: #3E3A4F;">
                    ...
                    <div class="filter" style="background: #3E3A4F;">
                        <label>Year</label><br>
                    ...
                    <div class="rowOne M twoColumn">
                        <div class="columnOne M twoRow">
                            ...
                            <div class="rowTwo-T threeColumn transparent spacerTop">
                                ...
                                <div class="columnTwo SM round shadow white">
