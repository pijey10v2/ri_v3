                    ...
                    <div class="rowOne M twoColumn">
                        <div class="columnOne M twoRow">
                            <div class="rowTwo-T fourRow roundB shadow">
                                ...
                                <div class="rowOne M infoContainerDiv procurement">
                                    ...
                                    <div class="infoContainer procurement reMargin shadow">
                                        <div class="head">APPROVED VO (APK)</div>
                                        <div class="body centerMiddle">
                                            <span id = "approvedVo_apk">0</span>
                                        </div>
                                    </div>
                                    <div class="infoContainer procurement reMargin shadow">
                                        <div class="head">APPROVED VO (PHK)</div>
                                        <div class="body centerMiddle">
                                            <span id = "approvedVo_phk">0</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="rowTwo M infoContainerDiv procurement">
                                    ...
                                    <div class="infoContainer procurement reMargin shadow">
                                        <div class="head">IPA (RM)</div>
                                        <div class="body centerMiddle">
                                            <span id = "ttlIpaAmount">0</span>
                                        </div>
                                    </div>
                                    <div class="infoContainer procurement reMargin shadow">
                                        <div class="head">IPC (RM)</div>
                                        <div class="body centerMiddle">
                                ...
                                <div class="rowOne M infoContainerDiv procurement">
                                    <div class="infoContainer procurement reMargin shadow">
                                        <div class="head">RECEIVE AMOUNT (RM)</div>
                                        <div class="body centerMiddle">
                        ...
                        <div class="columnTwo M twoRow">
                            <div class="rowTwo-T fourRow roundB shadow">
                                ...
                                <div class="rowOne M infoContainerDiv procurement">
                                    <div class="infoContainer procurement reMargin shadow">
                                        <div class="head">REMAINING CLAIMABLE AMOUNT (RM)</div>
                                        <div class="body centerMiddle">
                        ...
                        <div class="rowTwo-T twoColumn tableContainer roundB scroll-content noscrollPrint" style="display: block">
                            <table id="incidentTb" class=""> 
                                <thead style="position: sticky;" class="procurement">
                                    <tr>
                                        <th colspan="3" class="lightbluePastel" scope="colgroup" style="text-align:center; border: 1px solid white">PAYMENT CLAIM</th>
                                ...
                                <thead style="position: sticky;" class="procurement">
                                    <tr>
                                        ...
                                        <th class="secondRowBottom bluePastel" scope="colgroup" style="text-align:right; border: 1px solid white"></th>
                                        ...
                                        <th class="secondRowBottom bluePastel" colspan="1" scope="colgroup" style="text-align:center; border: 1px solid white"></th>
                                        ...
                                        <th class="secondRowBottom greenPastel" colspan="1" scope="colgroup" style="text-align:right; border: 1px solid white"></th>
                                    </tr>
                                    <tr style="height:25px">
                                        ...
                                        <th class="bottom bluePastel" scope="colgroup" style="text-align:right; border: 1px solid white"></th>
                                        ...
                                        <th class="bottom bluePastel" colspan="1" scope="colgroup" style="text-align:center; border: 1px solid white"></th>
                                        ...
                                        <th class="bottom greenPastel" colspan="1" scope="colgroup" style="text-align:right; border: 1px solid white"></th>
                                    </tr>
                                </thead>
                            </table>
                        </div>
