...
$dashObj = new RiDashboard('HSE_PBHS', false, 0);
            ...
            <div class="layout oneRow" id="lOne"> 
                <div class="columnOne threeRow main-div">
                    <div class="rowOne M twoColumn round"> 
                        ...
                        <div class="columnTwo SM twoColumn round background">
                            ...
                            <div class="columnTwo M flex">
                                <div class="infoContainer round">
                                    <div class="head roundT">CUMULATIVE TOTAL MAN-HOURS WITH LTI (hrs)</div>
                    ...
                    <div class="rowTwo M twoColumn round">
                        ...
                        <div class="columnTwo SM twoRow round">
                            <div class="rowOne-T roundT">
                    ...
                    <div class="rowThree M twoColumn round">   
                        <div class="columnOne M60 twoColumn" style="background: transparent; padding: 0 0 10px 0;">
                            <div class="columnOne M twoColumn">
                                <div class="columnOne M twoRow round">
                                    <div class="rowOne-T roundT smallSize">
                            ...
                            <div class="columnTwo M twoColumn">
                                ...
                                <div class="columnTwo M twoRow round">
                                    ...
                                    <div class="dash-charts rowTwo-T roundB" id="HSEPreToolbox"></div> 
                                </div>
                            </div>
                        </div>
                        <div class="columnTwo M40 twoRow round">
                            <div class="rowOne-T roundT">
                                HSET PROGRAM AND RESPONSE
                            </div>
