        ...
        >
            <div class="layout twoRow round" id="lOne">
                <div class="rowOne M twoRow">
                    ...
                    <div class="rowTwo-T gridContainer roundB shadow overflowScroll" style="padding: 0 10px; width: calc(100% - 20px) !important;">
                        <div class="infoContainerDiv procurement">
                            <div class="infoContainer procurement reMargin shadow" style="width: 100%;font-size: 11px !important">
                        ...
                        <div class="infoContainerDiv procurement">
                            <div class="infoContainer procurement reMargin" style="font-size: 11px !important">
                        ...
                        <div class="infoContainerDiv procurement">
                            <div class="infoContainer procurement transparent">
                            </div> 
                            <div class="infoContainer procurement transparent">
                            </div>
                            <div class="infoContainer procurement reMargin" style="font-size: 11px !important">
                ...
                <div class="rowTwo M twoRow">
                    <div class="rowOne-T roundT">INTERIM PAYMENT</div>
