            ...
            <div class="sidebar">
                <div class="filterContainer" >
                    ...
                    <div class="filter">
                        ...
                        <select id="issueStatusFilter" onchange="refreshDashboard();">
                    ...
                    <div class="filter">
                        <label>Issue - Source</label><br>
                        <select id="sourceFilter" onchange="refreshDashboard();">
                            <option value="all">All</option>
                        </select>
                    </div>
                </div>
            ...
            <div class="layout twoRow" id="lOne">
                <div class="rowOne M twoRow">
                    ...
                    <div class="rowTwo-T transparent twoColumn">
                        ...
                        <div class="columnTwo S round flex white" style="margin: 5px 0 5px 5px; height: calc(100% - 5px)">
                    ...
                    <div class="rowTwo-T transparent twoColumn">
                                ...
                                <table id ="" style="background: transparent;">
                                    <thead style="background: transparent;">
                                        <tr style="baWckground: transparent;">
                                            ...
                                            <th>ISSUES</th>
                                            <th>DATE</th>
                                            <th style="border-top-right-radius: 5px;">SOURCE</th>
                                        </tr>
                                    </thead>
                                    <tbody id="landTBody">
                        ...
                        <div class="columnTwo S round flex white" style="margin: 5px 0 5px 5px; height: calc(100% - 5px)">
                            ...
                            <div class="infoContainer">
                                ...
                                <span id = "landClosedCard">0</span>
                            </div>
                            <div class="infoContainer">
                                <div class="head">PENDING</div>
                                <span id = "landPendingCard">0</span>
                            </div>
                        </div>
                    </div>
                </div>
