...
$dashObj = new RiDashboard('HSE_PBHS');
            ...
            <div class="layout oneRow" id="lOne"> 
                <div class="columnOne threeRow main-div">
                        ...
                        <div class="columnTwo SM twoColumn round shadow" style="background:white;">
                            <div class="columnOne M flex">
                                <div class="infoContainer round shadow">
                                    <div class="head roundT">OVERALL CUMULATIVE TOTAL MAN-HOURS WITHOUT LTI (hrs)</div>
                            ...
                            <div class="columnTwo M flex">
                                <div class="infoContainer round shadow">
                                    <div class="head roundT">OVERALL CUMULATIVE TOTAL MAN-HOURS WITH LTI (hrs)</div>
                    ...
                    <div class="rowThree M twoColumn round">   
                        <div class="columnOne M60 fourColumn" style="background: transparent; padding: 0 0 10px 0;">
                            ...
                            <div class="columnFour M twoRow round shadow">
                                <div class="rowOne-T roundT smallSize">
                                    PRE-TOOLBOX MEETING
                                </div>
