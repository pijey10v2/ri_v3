...
$dashObj = new RiDashboard('procurement');
        ...
        >
            ...
            <div class="layout oneRow" id="lOne">
                <div class="columnOne twoRow main-div">
                    <div class="rowOne M twoColumn">
                        ...
                        <div class="columnTwo M twoRow">
                            ...
                            <div class="rowTwo-T fourRow roundB shadow">
                                <div class="rowOne M infoContainerDiv procurement">
                                    <div class="infoContainer procurement reMargin shadow" style="width: 100%; margin: 5px">
                    ...
                    <div class="rowTwo M twoRow positionRelative">
                        <div class="rowOne-T roundT shadow">INTERIM PAYMENT</div>
                        <div class="rowTwo-T twoColumn tableContainer scrollbar-inner roundB scroll-content">
                            <table id="incidentTb" class=""> 
                                <thead style="position: sticky;" class="procurement">
                                    ...
                                    <tr>
                                        <th class="secondRow lightbluePastel" scope="col" style="text-align:center; border: 1px solid white">CONTRACT NO</th>
                                ...
                                <thead style="position: sticky;" class="procurement">
                                    <tr>
                                        <th class="secondRowBottom lightbluePastel" colspan="3" scope="colgroup" style="text-align:right; border: 1px solid white">Total (MYR)</th>
                                    ...
                                    <tr>
                                        <th class="bottom lightbluePastel" colspan="3" scope="colgroup" style="text-align:right; border: 1px solid white">Percentage (%)</th>
