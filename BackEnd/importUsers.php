	...
	if(isset($_SESSION['email'])){
        ...
        for($i=1; $i<$length; $i++){
            ...
            if($res_row==true){
                ...
                if($myresp == "" || $myresp1 == ""){ //user was not created in joget. so exit
                    ...
                    }else if($myresp1->message != "User Created"){ //user was not created in joget. so exit
                        array_push($data, (object)[
                            'email' => $email,
                            'reason' =>$myresp1->message
                        ]); 
